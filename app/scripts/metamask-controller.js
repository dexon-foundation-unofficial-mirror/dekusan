...
const TrezorKeyring = require('@dexon-foundation/eth-trezor-keyring')
const LedgerBridgeKeyring = require('@dexon-foundation/eth-ledger-bridge-keyring')
